REM   Script: Analytics - The LISTAGG function
REM   SQL from the KISS (Keep It Simply SQL) Analytic video series by Developer Advocate Connor McDonald. This script looks at the listagg function to concatenate rows into a list.
...
select deptno,
           listagg( ename, ',')
             within group (order by empno) members
    from   emp
group by deptno
order by 1;
